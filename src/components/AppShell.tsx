            ...
            <div className="flex flex-1 flex-col">
              ...
              >
                ...
                >
                  ...
                  <span
                    className={cn(
                      "absolute left-1/2 top-1/2 z-10 translate-x-[calc(-2.25rem+20px)] -translate-y-1/2 text-[22px] font-medium leading-none text-white/90 [text-shadow:0_1px_2px_rgba(0,0,0,0.75)]",
