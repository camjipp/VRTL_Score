...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-surface-2/30">
      {/* Sidebar */}
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-60 flex-col bg-surface border-r border-border transition-transform duration-200 lg:relative lg:translate-x-0",
      ...
      >
        ...
        <div className="flex h-16 items-center gap-3 px-5">
          ...
          <div>
            <div className="text-sm font-semibold text-text">VRTL Score</div>
            <div className="text-[11px] text-text-3">AI Visibility</div>
          </div>
        </div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          ...
          >
            <svg className={cn("h-5 w-5", isActive("/app") ? "text-emerald-600" : "text-text-3")} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          >
            <svg className={cn("h-5 w-5", isActive("/app/settings") ? "text-emerald-600" : "text-text-3")} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="border-t border-border p-3 space-y-1">
          {agency && (
            <div className="flex items-center gap-3 rounded-xl bg-surface-2/50 px-3 py-2.5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[11px] text-text-3">Your agency</div>
              </div>
            </div>
          )}
          ...
          <Link
            href="/"
            className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-text-2 transition-all hover:bg-surface-2 hover:text-text"
          >
            <svg className="h-5 w-5 text-text-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="flex flex-1 flex-col">
        {/* Mobile header */}
        <header className="flex h-16 items-center gap-4 border-b border-border bg-surface px-4 lg:hidden">
          <button
            onClick={() => setSidebarOpen(true)}
            className="flex h-10 w-10 items-center justify-center rounded-xl text-text-2 hover:bg-surface-2"
          >
