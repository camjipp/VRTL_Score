...
type DownloadPdfButtonProps = {
  snapshotId: string;
  className?: string;
  /** default = full-width CTA; compact = filled small; ghost = secondary outline */
    ...
    return (
      <div className={className}>
        ...
        >
          ...
          {busy ? "…" : success ? "Saved" : (label ?? "Report")}
        </button>
        {error && (
    ...
    return (
      <div className={className}>
        ...
        >
          ...
          {busy ? "Generating..." : success ? "Downloaded!" : "Download Client Report"}
        </button>
        {error && (
          <Alert className="mt-2 py-2" variant="danger">
            <AlertDescription>{error}</AlertDescription>
