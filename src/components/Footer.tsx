...
const footerLinks = {
  ...
  features: [
    ...
    { label: "Optimization Insights", href: "/#product" },
    { label: "Branded PDF Reports", href: "/#product" },
  ],
  models: [
    { label: "ChatGPT", href: "/#product" },
    { label: "Claude", href: "/#product" },
    { label: "Gemini", href: "/#product" },
    { label: "Perplexity", href: "/#product" },
    { label: "DeepSeek", href: "/#product" },
  ],
  resources: [
    { label: "FAQ", href: "/#faq" },
    { label: "What is AI Visibility?", href: "/#faq" },
    { label: "AI Search Optimization", href: "/#category" },
  ],
};
