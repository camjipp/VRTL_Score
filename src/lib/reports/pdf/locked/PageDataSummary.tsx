  ...
  return (
    <PdfInnerPage title={LOCKED_PAGE_HEADER[8]!}>
      <View style={local.band} wrap={false}>
        ...
        {interp ? <Text style={lockedStyles.bandCaption}>{interp}</Text> : null}
        ...
        {signals.map((r, i) => {
          const trSt = i % 2 === 1 ? lockedStyles.data_trAlt : lockedStyles.data_tr;
          return (
            <View key={`s-${i}`} style={[trSt, local.trH]} wrap={false}>
      ...
      <View style={local.band} wrap={false}>
        <View style={lockedStyles.data_bandHeader}>
          <Text style={lockedStyles.data_bandTitle}>Competitive set</Text>
        </View>
        <View style={[lockedStyles.data_th, local.thH]}>
        ...
        {comp.map((r, i) => {
          const trSt = i % 2 === 1 ? lockedStyles.data_trAlt : lockedStyles.data_tr;
          return (
            <View key={`c-${i}`} style={[trSt, local.trH]} wrap={false}>
