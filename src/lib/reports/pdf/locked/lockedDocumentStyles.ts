...
export const lockedStyles = StyleSheet.create({
  ...
  perf_miniBarFill: { height: 4, backgroundColor: LD.color.accent },
  perf_miniBarRest: { height: 4, backgroundColor: LD.color.rule },
  perf_takeawayLine: {
    fontSize: LD.size.title,
    fontFamily: LD.font.sansBold,
    color: LD.color.ink,
  ...
  perf_zoneLegendSeg: { height: 4, marginRight: 2 },
  perf_zoneLegendLabel: {
    fontSize: 5.5,
    fontFamily: LD.font.sans,
    color: LD.color.ink4,
  ...
  comp_cellName: { width: "28%", paddingRight: LD.space.xs, paddingLeft: LD.space.xs },
  comp_cellNum: { width: "10%", paddingRight: 2 },
  comp_cellBar: { width: "36%", paddingRight: LD.space.xs, justifyContent: "center" },
  comp_cellRate: { width: "12%" },
  comp_cellRank: { width: "10%" },
  comp_cellFlag: { width: "14%" },
